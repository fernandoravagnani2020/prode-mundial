...
export async function POST(req: NextRequest) {
  ...
  const match = await dbGet<{ id: number; match_date: string; status: string; score1: number | null; score2: number | null }>(
  ...
  `, [dni, match_id, predicted_score1, predicted_score2, points]);
